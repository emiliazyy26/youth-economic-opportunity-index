...
**Urban Economic Opportunity Index (YEOI / YEOI)** 是一个面向中国城市比较、**聚焦年轻人与职场早期人群**的经济数据分析项目。项目关注毕业生和青年职场人在选择城市时的核心权衡：就业机会、起薪回报、生活成本、大企业机会与长期增长潜力。
...
收入是 YEOI 中权重最高的指标，因为它直接反映年轻人在城市中的收入机会和实际购买力。
...
大学资源作为人才资本维度进入 YEOI 主公式（权重 0.15）。
...
2. 每条核心数据都有来源记录；
3. 能通过 `uv run yeoi-build` 生成指数结果；
4. 至少有 5 张可用于报告的图表；
